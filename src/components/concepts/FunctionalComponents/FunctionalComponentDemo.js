                ...
                <div> 
                    ...
                    <dl>
                        ...
                        <dt>No <i>this</i> keyword</dt>
                            <dd>Class Components (or stateful components) in React will always require the use of the <i>this</i> keyword when initializing an object using the constructor method. Functional components (or display components), however, are instanceless meaning the have no access to the <i>this</i> keyword</dd>
                        <dt><i>return()</i></dt>
