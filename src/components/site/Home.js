    ...
    return (
        <div className='main'>
            <div className='mainDiv'>
                ...
                <p>
                    This app is intended to be a starter/tutorial app for your upcoming project and learning sandbox for you in months and years to come should you continue to develop software with React. In this application, we will work through some of the basic React concepts, build our some small applications, then unleash you to build your own applications.
                </p>
                <hr />
                <h1>Important Notes</h1>
                <ul>
                    <li>Being compenent based, you can move on to the next module</li>
                    ...
                    <li>The set us for this app might be the most confusing part. Hand in there!</li>
                    <li>
