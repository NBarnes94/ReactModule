    ...
    return (
        <div className="main">
            <div className='mainDiv'>
                ...
                <p>Below are some resources we used throughout this app. NoteL you have one challenge where you will be asked to make this page better.</p>
                <ul>
                    <li>
                    ...
                    <li>
                        <a href="https://www.udemy.com/course/react-the-guide-incl-redux" target='_blank'>
                            Maximillion Schwarzmuller's Udemy Course
                        </a>
                    </li>
                    <li>
